...
static void exception_server (mach_port_t exceptionPort) {
    ...
    MachMessage *message;
    mach_msg_port_descriptor_t *descriptor1;
    mach_msg_port_descriptor_t *descriptor2;
    void * inlinedata;
...
//    mach_message message;
    ...
    while (1) {
        ...
        message = (MachMessage *)msg;
        descriptor1 = (mach_msg_port_descriptor_t *)((char *)msg + sizeof(msg) + sizeof(mach_msg_body_t));
        descriptor2 = descriptor1 + 1;
